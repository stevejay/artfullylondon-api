...
const strategyFactory = require("../../src/venue-processing/venue-strategy-factory");
const strategyRunner = require("../../src/venue-processing/venue-strategy-runner");
...
describe("venue event monitor integration tests", () => {
  ...
  venueIds.forEach(venueId => {
    it("should process venue " + venueId, async () => {
      request.get = jest.fn().mockResolvedValue({ items: [] });
