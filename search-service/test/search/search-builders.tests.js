...
const searchBuilders = require('../../lib/search/search-builders');
const time = require('../../lib/search/time');
...
describe('search-builders', () => {
  describe('buildTalentRelatedEventsSearchPreset', () => {
    ...
    beforeEach(() => {
      timeStub = sinon.stub(time, 'getLondonNow');
    });

    afterEach(function() {
      time.getLondonNow.restore();
    });

    it('should build a correct search', () => {
      timeStub.returns(new moment('2017/06/25', 'YYYY/MM/DD'));
  ...
  describe('buildFeaturedEventsSearchPreset', () => {
    ...
    it('should build a featured events search', () => {
      timeStub.returns(new moment('2017/01/16', 'YYYY/MM/DD'));
