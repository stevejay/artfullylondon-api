...
describe("event normalisers", () => {
  ...
  it("should apply event normalisers to times audience tags", () => {
    ...
    expect(params.specialOpeningTimes[0].audienceTags).toEqual(undefined);
    expect(params.specialPerformances[0].audienceTags).toEqual(undefined);
    expect(params.images[0].copyright).toEqual(undefined);
    expect(params.images[0].dominantColor).toEqual(undefined);
  });
});
