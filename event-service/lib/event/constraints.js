...
module.exports = {
  ...
  occurrenceType: {
    ...
    dependency: [
      ...
      },
      {
        ...
        message: 'Date to must be greater than or equal to date from and both must be given',
      },
      {
  ...
  costType: {
    ...
    dependency: [
      ...
      },
      {
        ...
        message: 'Cost to must be greater than or equal to cost from and both must be given',
      },
    ],
  },
  costFrom: {
  ...
  useVenueOpeningTimes: {
    ...
    dependency: {
      ...
      message: 'Cannot use venue opening times if event is a performance or a course',
    },
  },
  timesRanges: {
    array: true,
      ...
      object: {
        ...
        dateTo: {
          ...
          dependency: {
            ...
            message: 'For each times range, Date To must be greater than Date From',
          },
        },
        label: {
          presence: true,
        ...
        test: value => value && value.length > 0,
          ...
          (attrs.eventType === constants.EVENT_TYPE_PERFORMANCE &&
            every(attrs.performances, x =>
              find(value, y => y.id === x.timesRangeId))),
        message: 'All Opening Times / Performances must have a recognized Times Range Id',
      },
    ],
  },
  openingTimes: {
  ...
  mediumTags: {
    ...
    length: globalConstraints.TAGS_LENGTH,
    each: globalConstraints.EACH_TAG_CONSTRAINT(
      globalConstants.TAG_TYPE_MEDIUM
    ),
  },
  styleTags: {
    array: true,
