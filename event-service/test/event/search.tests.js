...
const search = require('../../lib/event/search');
...
describe('search', () => {
  ...
  describe('removeSoldOutPerformances', () => {
    const tests = [
      ...
      {
        it: 'should handle a sold out performance that applies on a day that has multiple performances',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_PERFORMANCE,
            soldOutPerformances: [{ date: '2016/12/23', at: '18:00' }],
  ...
  describe('removeNamedClosuresDates', () => {
    const tests = [
      ...
      {
        it: 'should ignore a exhibition event that is not using the venue opening times',
        args: {
          event: {
  ...
  describe('removeFullDayClosureDates', () => {
    const tests = [
      ...
      {
        it: 'should handle exhibition event with event and venue full day closures',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: true,
      ...
      {
        it: 'should handle exhibition event with event and venue full day closures but venue times are not being used',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: false,
  ...
  describe('addRegularTimes', () => {
    const tests = [
      ...
      {
        it: 'should handle no regular times for an exhibition event that uses venue times',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: true,
      ...
      {
        it: 'should handle regular times for an exhibition event that uses the venue times',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: true,
      ...
      {
        it: 'should handle regular times with times ranges for a performance event',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_PERFORMANCE,
            timesRanges: [
      ...
      {
        it: 'should handle regular times with times ranges rejection for a performance event',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_PERFORMANCE,
            timesRanges: [
  ...
  describe('addAdditionalTimes', () => {
    const tests = [
      ...
      {
        it: 'should handle an exhibition event with additional times on the venue',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: true,
      ...
      {
        it: 'should handle an exhibition event with additional times on the event and the venue',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            additionalOpeningTimes: [
  ...
  describe('removePartDayClosureDates', () => {
    const tests = [
      ...
      {
        it: 'should handle no part day closures on an exhibition event that uses venue times',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: true,
      ...
      {
        it: 'should handle part day closures on an exhibition event that uses venue times',
        args: {
          event: {
            eventType: constants.EVENT_TYPE_EXHIBITION,
            useVenueOpeningTimes: true,
  ...
  describe('createSearchDateObjects', () => {
    describe('performance event', () => {
      const tests = [
        ...
        {
          it: 'should handle special performances that match both performances and additional performances',
          args: {
            event: {
              eventType: 'Performance',
              occurrenceType: 'Bounded',
    ...
    describe('exhibition event that does not use venue opening times', () => {
      const tests = [
        ...
        {
          it: 'should handle opening times with a time closure before the regular times',
          args: {
            event: {
              eventType: 'Exhibition',
              occurrenceType: 'Bounded',
        ...
        {
          it: 'should handle opening times with a time closure after the regular times',
          args: {
            event: {
              eventType: 'Exhibition',
              occurrenceType: 'Bounded',
    ...
    describe('exhibition event that uses venue opening times', () => {
      const tests = [
        ...
        {
          it: 'should apply venue opening times and duplicate additions at both venue and event levels',
          args: {
            event: {
              eventType: 'Exhibition',
              occurrenceType: 'Bounded',
        ...
        {
          it: 'should apply venue opening times and non-duplicate additions at both venue and event levels',
          args: {
            event: {
              eventType: 'Exhibition',
              occurrenceType: 'Bounded',
