...
const date = require('../../lib/event/date');
...
describe('date', () => {
  ...
  describe('createStringDateFromMoment', () => {
    it('should create a string date', () => {
      ...
      expect(actual).to.eql('2016/12/25');
    });
  });
  ...
  describe('createMomentFromStringDate', () => {
    it('should create a moment', () => {
      ...
      expect(actual.year()).to.eql(2016);
      expect(actual.month()).to.eql(11);
      expect(actual.date()).to.eql(25);
    });
  });
  ...
  describe('createStringDateFromToday', () => {
    it('should create a date for today', () => {
      ...
      expect(actual).to.match(/^\d\d\d\d\/\d\d\/\d\d$/);
    });
