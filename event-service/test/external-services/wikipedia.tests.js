...
const wikipedia = require('../../lib/external-services/wikipedia');
...
describe('wikipedia', () => {
  describe('getDescription', () => {
    ...
    it('should get a wikipedia description', done => {
      ...
      const path = '/w/api.php?format=json&action=query&prop=extracts&exintro=&explaintext=&titles=Rabbit&exchars=4000';
    ...
    it('should not overwrite an existing description', () => {
      ...
      expect(result).to.eql({ content: 'not empty', credit: 'some credit' });
    });
